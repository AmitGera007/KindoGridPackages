import { Component, Input, Output, EventEmitter, HostBinding, ViewChild, Inject, Optional, OpaqueToken, NgZone } from '@angular/core';
...
var ListComponent = (function () {
    function ListComponent(scrollerFactory, detailsService, changeNotification, suspendService, rtl, groupsService, ngZone) {
    ...
    ListComponent.prototype.ngAfterViewInit = function () {
        ...
        if (!isUniversal()) {
            this.subscriptions.add(Observable.fromEvent(this.container.nativeElement, 'scroll')
