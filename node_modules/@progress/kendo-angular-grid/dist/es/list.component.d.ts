import { OnInit, EventEmitter, ElementRef, OnDestroy, AfterViewInit, SimpleChange, OnChanges, OpaqueToken, QueryList, NgZone } from '@angular/core';
...
export declare class ListComponent implements OnInit, OnDestroy, AfterViewInit, OnChanges {
    ...
    constructor(scrollerFactory: any, detailsService: DetailsService, changeNotification: ChangeNotificationService, suspendService: SuspendService, rtl: boolean, groupsService: GroupsService, ngZone: NgZone);
    ngOnInit(): void;
    ngOnChanges(changes: {
